...
def solve(aunts):
    ...
    for idx, sue in enumerate(aunts):
        ...
        for item in sue:
            ...
            # Nested if's above because the below condition
            # should not accept those special items above
            elif item in requirements and requirements[item] != sue[item]:
                is_correct_sue = False
                break
