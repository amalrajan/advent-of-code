...
vector<vector<char>> simulateBeamPath(vector<vector<char>> &grid)
{
    ...
    dfsStack.push(make_tuple(0, 0, 0, 1));
...
int main()
{
    ...
    vector<vector<char>> track = simulateBeamPath(grid);
    // displayGrid(track);

    cout << "Ans: " << countEnergizedTiles(track) << endl;
